...
import { ClipboardPen, BrainCircuit, BadgeCheck, Globe } from "lucide-react";
  ...
  const steps = [
    {
      step: "1",
      title: "Create & Define",
      desc: "Educators build assessments and define success criteria with our AI rubric builder.",
      icon: <ClipboardPen />,
    },
    {
      step: "2",
      title: "Submit & Grade",
      desc: "Learners submit work, and our AI provides instant, unbiased grading and feedback.",
      icon: <BrainCircuit />,
    },
    {
      step: "3",
      title: "Issue & Award",
      desc: "A secure, verifiable credential is automatically minted on the blockchain and awarded.",
      icon: <BadgeCheck />,
    },
    {
      step: "4",
      title: "Share & Verify",
      desc: "Learners share their badges, and anyone can instantly verify their authenticity online.",
      icon: <Globe />,
    },
  ];
