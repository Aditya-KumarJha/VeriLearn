  ...
  return (
    <div className="relative bg-white dark:bg-black/90 p-10 flex flex-col justify-center items-center text-center text-gray-900 dark:text-gray-100 rounded-l-2xl">
      <h1 className="text-4xl font-bold z-10 mb-4">
        {page === "login" ? "Welcome Back to VeriLearn" : "Join VeriLearn"}
      </h1>
      <p className="mt-2 max-w-md z-10 text-lg opacity-90 mb-6">
        {page === "login"
          ? "Access your VeriLearn profile securely and continue your learning journey with verified credentials."
          : "Sign up to VeriLearn and get tamper-proof, portable credentials backed by blockchain verification."}
      </p>
