...
export default function HeroSection() {
  const images = [
    { src: "/card/Card-1.png", alt: "VeriLearn Student Dashboard" },
    { src: "/card/Card-2.png", alt: "AI Rubric Builder" },
    { src: "/card/Card-3.png", alt: "Verifiable Credential Badge" },
    { src: "/card/Card-4.png", alt: "Public Verification Page" },
  ];
    ...
    <section className="relative overflow-hidden pt-0 md:pt-10">
      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-start md:justify-between gap-12 relative z-10">
        <div className="md:w-3/5 mt-8 flex flex-col items-start text-left space-y-4">
          ...
          >
            VeriLearn <span className="text-blue-600 dark:text-blue-400">— Proof of Learning</span>
          </h1>
          ...
          >
            AI-graded, tamper-evident credentials for learners. Issue and verify academic achievements on the blockchain.
          </p>
