      ...
      <div className="px-10 sm:px-15 py-10 sm:py-12">
        ...
        <section className="space-y-8 leading-relaxed text-base sm:text-lg">
          <div>
            ...
            <p>
              By accessing or using <strong>VeriLearn</strong>, you agree to these Terms. 
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>You may not use VeriLearn for spamming, phishing, or distributing malicious software.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              to VeriLearn are owned by us or our licensors. You may not copy, 
          ...
          <div>
            ...
            <p>
              ...
              violate these Terms or engage in activity that may harm VeriLearn 
          ...
          <div>
            ...
            <p>
              To the maximum extent permitted by law, VeriLearn shall not be held 
          ...
          <div>
            ...
            <p>
              ...
              VeriLearn after changes constitutes acceptance of the new Terms.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              contact us at{" "}
              <a
                href="mailto:noreplyverilearn@gmail.com"
                className="text-blue-600 dark:text-blue-400 underline hover:opacity-80"
              >
                noreplyverilearn@gmail.com
              </a>.
            </p>
          </div>
        </section>
