    ...
    <main className="min-h-screen bg-white-50 text-gray-800 dark:bg-black dark:text-gray-100 transition-colors duration-300">
      ...
      <div className="px-10 sm:px-15 py-10 sm:py-12">
        ...
        <section className="space-y-8 leading-relaxed text-base sm:text-lg">
          <p>
            This Privacy Policy explains how <strong>VeriLearn</strong> (“we”, “us”, or “our”) collects, uses, and protects information when you use our platform to submit assignments, receive AI-based evaluations, and manage Proof of Learning credentials. We are committed to protecting your privacy and ensuring your personal information is handled responsibly.
          </p>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Submission data:</strong> assignments, code repositories, files, grading results, feedback, and credential metadata.</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Enable assignment submissions and AI-based evaluations.</li>
              <li>Issue, store, and verify Proof of Learning credentials.</li>
          ...
          <div>
            ...
            <p>
              We process personal data based on your consent, to fulfill contractual obligations (e.g., providing credentials), comply with legal requirements, or to protect legitimate interests such as academic integrity, security, and fraud prevention.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-2">
              ...
              page or contact{" "}
              <a href="mailto:support@verilearn.com" className="text-blue-600 dark:text-blue-400 underline hover:opacity-80">
          ...
          <div>
            ...
            <p>
              VeriLearn integrates with third-party services such as cloud storage, blockchain networks, and authentication providers (e.g., Google, LinkedIn). These services have their own privacy policies, and your data may be shared with them according to those policies.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Our services are not directed to children under 13, and we do not knowingly collect personal information from them. If we become aware that a child has provided us with personal data, we will take steps to delete it promptly unless required for verified academic use cases with institutional consent.
            </p>
          </div>
